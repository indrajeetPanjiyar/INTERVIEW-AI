...
async function generateInterviewReport({ resume, selfDescription, jobDescription }) {
    ...
    const prompt = `Analyze the candidate and generate an interview report.
                    ...
                    5. Do NOT return arrays like:
                    ["question","text","intention","text"]
                    6. Every array element must be a JSON object.
                    7. Return at least:
...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
    ...
    const prompt = `Generate resume for a candidate with the following details:
                        ...
                        The html field must contain complete HTML.
                    `
